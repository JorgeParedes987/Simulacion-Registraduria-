...
import com.registraduria.seguridad.Modelos.PermisosRoles;
import com.registraduria.seguridad.Repositorios.RepositorioPermiso;
import com.registraduria.seguridad.Repositorios.RepositorioPermisosRoles;
...
String id_permiso){
    ...
    public PermisosRoles getPermiso(@PathVariable String id_rol,
        ...
        if (elPermiso!=null && elRol!=null){
            return
                    this.miRepositorioPermisosRoles.getPermisoRol(elRol.get_id(),
                            elPermiso.get_id());
        }else{
            return null;
        }
